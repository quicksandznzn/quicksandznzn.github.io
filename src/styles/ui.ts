...
export const s = stylex.create({
  ...
  homeLinks: { display:'flex', alignItems:'center', gap:18, color:colors['--accent'], fontSize:13 },
  themeButton: { width:32, height:32, padding:0, borderWidth:0, display:'grid', placeItems:'center', backgroundColor:'transparent', color:{ default:colors['--accent'], ':hover':colors['--ink'] }, cursor:'pointer' },
